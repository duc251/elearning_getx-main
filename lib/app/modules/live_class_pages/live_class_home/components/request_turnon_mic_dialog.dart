...
class RequestTurnOnMicDialog extends StatelessWidget {
  final controller = Get.find<LiveClassHomeController>();
  // int idRoom;
  RequestTurnOnMicDialog({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: SvgPicture.asset(R.ASSETS_SVG_IC_MIRO_REQUIREONMIC_SVG, color: colorSemanticBlue100),
            ),
            Text("Yêu cầu bật Mic", style: typoBold16.copyWith(color: colorSecondaryNeutralWhite)),
            Container(
            ...
            Row(
              children: [
                ...
                Expanded(
                  ...
                  onTap: () {
                    Get.find<LiveClassHomeController>().tapMicro();
                    Get.back();
                    Get.find<LiveClassService>().isShowTurnOnMic.value = false;
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        SvgPicture.asset(R.ASSETS_SVG_IC_MIRO_REQUIREONMIC_SVG, color: colorWhite),
                        SizedBox(
                          width: 4,
                        ),
                        Text("Bật Mic", style: typoBold16.copyWith(color: colorWhite))
                      ],
                    ),
                  ),
                )
