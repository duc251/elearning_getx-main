...
class LearningProgressController extends GetxController {
  //TODO: Implement LearningProgressController
  final learnProgress = List<Datum>.empty(growable: true).obs;
  final learnNotComplete = List<Datum>.empty(growable: true).obs;
  ...
  void getListLearnProgress() async {
    try {
      ...
      if (response.error.isEmpty) {
        ...
        final learnNotCompletes = learnProgress
        ...
        final bookComplete =
            learnProgress.where((e) => e.totalProgress! >= 100);
        learnContinueProgress.value = bookContinue.toList();
        learnNewProgress.value = bookNew.toList();
        learnNotComplete.value = learnNotCompletes.toList();
